defmodule WhiteboardWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {WhiteboardWeb.Layouts, :root}
  ...
  if Application.compile_env(:whiteboard, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: WhiteboardWeb.Telemetry
